...
{    var cityQuery=city||cityName.value
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityQuery}&units=metric&appid=fba0575d6e905c40bbc079158b16e385`)
    .then(res=> res.json())
...
{    
    fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lati}&lon=${longi}&units=metric&appid=fba0575d6e905c40bbc079158b16e385`)
    .then(res=> res.json())
    .then(data=>showData(data))
    .catch(err=>
    {
